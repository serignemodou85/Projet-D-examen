...
<div class="container-fluid p-5 position-relative text-white" style="background-color: var(--accent-color); height:300px;">
    ...
    <div class="text-center">
        <h1 class="fw-bold animate__animated animate__fadeInDown">Déclarer un bien retrouvé</h1>
        <p class="mt-3">
            <a href="" class="text-decoration-none text-light fw-bold">ACCUEIL</a>
            / <span class="text-light">Déclarer un bien retrouvé</span>
        </p>
    </div>
</div>
<br>
...
<br>
<hr>
<h1 class="for1">Formulaire de déclaration d'un bien retrouvé</h1>
<div class="container mt-5">
    <div class="formulaire-container">
        <!-- Formulaire -->
        <form method="POST" action="{{ route('objets1.store') }}" enctype="multipart/form-data">
            @csrf
            @if ($errors->any())
            ...
            <div class="row g-3"> <!-- Utilisation de la classe gap pour l'espacement -->
                ...
                <div class="col-md-6 border" style="border: 1px solid black; padding: 15px;">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="titre" name="titre" placeholder="Ex: Sac à dos perdu">
                        @error('titre')
                ...
                <div class="col-md-6 border" style="border: 1px solid black; padding: 15px;">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nom" name="nom" placeholder="Nom complet de la personne" value="{{ old('nom') }}">
                    </div>
                    <div class="mb-3">
                        <label for="prenom" class="form-label">Prénom <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="prenom" name="prenom" placeholder="Prénom complet de la personne" value="{{ old('prenom') }}">
                    </div>
                    <div class="row">
                        <div class="col-6 mb-3">
                            <label for="telephone" class="form-label">Numéro de téléphone <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="telephone" name="telephone" placeholder="Ex: 772223344" value="{{ old('telephone') }}">
                        </div>
                        <div class="col-6 mb-3">
                            <label for="adresse" class="form-label">Adresse <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="adresse" name="adresse" placeholder="Adresse de la personne" value="{{ old('adresse') }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6 mb-3">
                            <label for="lieu" class="form-label">Lieu ? <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="lieu" name="lieu_perte" placeholder="Lieu de la perte" value="{{ old('lieu_perte') }}">
                        </div>
                        <div class="col-6 mb-3">
                            <label for="date" class="form-label">Date ? <span class="text-danger">*</span></label>
                            <input type="date" class="form-control" name="date_perte" id="date" max="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" value="{{ old('date_perte') }}">
                        </div>
                    </div>
                    <div class="form-check mb-3 custom-checkbox">
                        <input type="checkbox" class="form-check-input" id="afficher-telephone" name="afficher_telephone">
