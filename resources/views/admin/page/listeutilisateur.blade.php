            ...
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
						...
						<th style="width: 300px;">Addresse</th>
                        <th>Telephone</th>
                    </tr>
                </thead>
                <tbody>
					...
					<div id="editEmployeeModal{{ $utilisateur->id }}" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form method="post" action="{{ route('admin.page.traitement', $utilisateur->id) }}">
                                    @csrf
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label>Adresse</label>
                                            <textarea class="form-control" name="adresse" required>{{ $utilisateur->adresse }}</textarea>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <input type="submit" class="btn btn-success" value="Modifier Utilisateur">
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div id="deleteEmployeeModal{{ $utilisateur->id }}" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form method="POST" action="{{ route('admin.destroy', $utilisateur->id) }}">
                                    @csrf
